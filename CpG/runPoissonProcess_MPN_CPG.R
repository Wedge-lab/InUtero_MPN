...
dat <- list(
    ...
    m = c(89, 114),  # post-MRCA mutation estimates
    M = 2,  # pre-MRCA mutation estimates (use array to pass a single value)
    min_permitted_lower_bound = 0,
    max_permitted_lower_bound = 37, #age of youngest twin at presentation
    expon_rate = 0.58,  # parameter of exponential prior on mean mutation rate 
