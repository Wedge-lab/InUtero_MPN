...
parameters {
    ...
    real<lower=0, upper=24> rate; // rate parameter of the Poisson process (mutations per genome per unit time [year])
}
transformed parameters {
	vector<lower=0>[n] t = i_raw - t_mrca; // i is the post-MRCA interval
}
model {
